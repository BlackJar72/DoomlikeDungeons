...
public enum Difficulty {
     ...
     * @return
     */
    public boolean addmob(RandomSource random) {
     ...
     * @return
     */
    public boolean multimob(RandomSource random) {
     ...
     * @return
     */
    private boolean promote(RandomSource random) {
     ...
     * @return
     */
    public int moblevel(RandomSource random) {
        int lev = 0;
        boolean pr = true;
        while(pr && (lev < maxlev)) {
     ...
     * @return
     */
    public int nodelevel(RandomSource random) {
        int lev = nodelev;
        boolean pr = true;
