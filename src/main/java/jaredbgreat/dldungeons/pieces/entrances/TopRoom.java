...
public class TopRoom extends AbstractEntrance {
	 ...
	 * @param world
	 */
	private void buidBuilding(Dungeon dungeon, WorldGenLevel world) {
	 ...
	 * @param world
	 */
	private void buildRuin(Dungeon dungeon, WorldGenLevel world) {
	 ...
	 * @param dungeon
	 */
	private void buildLatter(WorldGenLevel world, Dungeon dungeon) {
	 ...
	 * @param dungeon
	 */
	private void buildStair(WorldGenLevel world, Dungeon dungeon) {
