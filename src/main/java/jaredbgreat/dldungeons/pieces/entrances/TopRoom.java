...
public class TopRoom extends AbstractEntrance {
	 ...
	 * @param world
	 */
	private void buidBuilding(Dungeon dungeon, ISeedReader world) {
	 ...
	 * @param world
	 */
	private void buildRuin(Dungeon dungeon, ISeedReader world) {
	 ...
	 * @param dungeon
	 */
	private void buildLatter(ISeedReader world, Dungeon dungeon) {
	 ...
	 * @param dungeon
	 */
	private void buildStair(ISeedReader world, Dungeon dungeon) {
